    ...
    >
      ...
      <div id="mc_embed_signup">
        ...
        <Paragraph className={styles.Desc}>
          Sign up for the Wicked Woods Music Festival mailing list to enter for
          your chance to win <Bold>1 ticket + early entry</Bold> for Wicked
          Woods Music Festival August 30 - September 1, 2024.
        </Paragraph>
        <form
          ...
          <div id="mc_embed_signup_scroll">
            ...
            <div className="mc-field-group">
              <select hidden name="CONTEST" className="" id="mce-CONTEST">
                <option selected value="Sub Chakra Holiday Mixer Giveaway">
      ...
      <div className={styles.TermsWrapper}>
        ...
        <UList>
          ...
          <ListItem>
            You will be given a contest ticket for each entry into the giveaway.
            Please keep the ticket(s) on you to validate and claim your prize.
          </ListItem>
          <ListItem>
            You can acquire additional entries into this contest in exchange for
            a donation to the event&apos;s Donation Collection pool. Minimum of
            $5 donation is required for each additional entry. 100% of donations
            go directly to the WIN Shelter and Calgary Food Bank on behalf of
            Sub Chakra.
          </ListItem>
          <ListItem>
